...
* Accédez à l'onglet Instantanés et sélectionnez le bouton *Créer un instantané*. Créez un instantané en mode veille de la machine virtuelle. Consultez  https://techdocs.broadcom.com/["Broadcom Documentation technique"^] pour plus de détails.
